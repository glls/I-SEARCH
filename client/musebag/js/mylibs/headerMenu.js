...
define(
    ...
    function(config, profile, query, loader) {
        ...
        var initSettingsPanel = function() {
            ...
            $("#max-distance").val(config.constants.queryOptions.maxDistance);
        ...
        var performLoggedInSetup = function() {
            ...
            $("#login-status").html("Hello " + profile.get('userId'));
      ...
      */
        ...
        var handleSettingsSave = function() {
            ...
            var md = parseInt(panels.settings.find("#max-distance").val() || config.constants.queryOptions.maxDistance);
            ...
            if(config.constants.queryOptions.maxNumResults=== mr &&
                config.constants.queryOptions.maxDistance === md &&
            ...
            config.set('queryOptions.maxDistance', md);
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    try {
                        ...
                        data = {
                            error: "The server gave me an invalid result."
                        };  
                    }
        ...
        var init = function() {
            ...
            profile.set('settings',{
                'useCase' : config.constants.queryOptions.useCase
            });
